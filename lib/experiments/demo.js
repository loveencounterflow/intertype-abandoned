...
//.........................................................................................................
  ...
  demo_object_shapes_ng = function() {
    var error, i, j, k, l, len, len1, len2, n, probe, probes, ref, ref1, type;
    isa.add_type('nonempty_text', function(x) {
      return (this.text(x)) && (this.nonempty(x));
    });
    isa.add_type({
      ...
      supertype: 'integer',
      tests: {
        isa_count: function(x) {
          return this.count(x);
        },
        multiple_of_10: function(x) {
          return this.multiple_of(x, 3);
        },
        not_too_big: function(x) {
          return x < 10;
        }
      }
    });
    ...
    for (i = 0, len = ref.length; i < len; i++) {
      ...
      info('µ33883', n, (error != null ? CND.red(error.message) : CND.lime('ok'))); 
    }
    return;
//.........................................................................................................
/* !!!!!!!!!!!!!!!!!!!!!!!!!! */    for (n = j = -4; j <= 10; n = ++j) {
...
//.........................................................................................................
    for (k = 0, len1 = probes.length; k < len1; k++) {
      probe = probes[k];
      ref1 = ['foobarcat', 'foobarflapcat'];
