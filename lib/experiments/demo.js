...
(function() {
  'use strict';
  var CND, alert, badge, debug, demo, demo_nested_errors, demo_object_shapes, echo, help, info, isa, jr, log, njs_path, praise, rpr, urge, warn, whisper;
  ...
  demo = function() {
    ...
    try {
      urge('µ44433-3', isa.validate.integer(123, "that should've been an $type: $value"));
    } catch (error1) {
      error = error1;
      warn(error.message);
    }
    try {
      urge('µ44433-4', isa.validate.integer(123.456, "that should've been an $type: $value"));
    } catch (error1) {
      error = error1;
      warn(error.message);
    }
  ...
  demo_object_shapes = function() {
    var error, i, j, len, n, probe, probes;
...
//.........................................................................................................
    ...
    //.........................................................................................................
    isa.add_type('foobarcat', function(x) {
      if (!this.pod(x)) {
        return false;
      }
      if (!this.has_only_keys(x, 'foo', 'bar', 'cat')) {
        return false;
      }
