...
(function() {
  'use strict';
  var CND, _xrpr, alert, assign, badge, cnd_by_ity, debug, flatten, get_rprs_of_tprs, help, info, inspect, isa, isa_type, ity_by_cnd, jr, rpr, tester_from_tests_object, urge, warn, whisper, xrpr,
    indexOf = [].indexOf,
  ...
  // ADDING TYPES
  //-----------------------------------------------------------------------------------------------------------
  tester_from_tests_object = function(tests) {
    return function(x) {
      var name, test;
      if (!(function() {
        var results;
