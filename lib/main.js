...
(function() {
  ...
  this.add_supertype = function(subtype, supertype) {
    ...
    if ((supertype = this.supertypes[subtype]) != null) {
  ...
  this.extends = function(subtype, supertype) {
    ...
    return this._extends(subtype, supertype);
  };

  //-----------------------------------------------------------------------------------------------------------
  this._extends = function(subtype, supertype) {
    if (subtype === supertype) {
      return true;
    }
    return (this.supertypes[subtype] === supertype) || (this._extends(this.supertypes[subtype], supertype));
  };
