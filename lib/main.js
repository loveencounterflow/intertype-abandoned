...
(function() {
  'use strict';
  var CND, alert, assign, badge, cnd_by_ity, debug, flatten, help, info, isa, isa_type, ity_by_cnd, jr, rpr, urge, warn, whisper,
  ...
  this.validate = function(x, type, message = null) {
    var error, prv_message, result, tester;
